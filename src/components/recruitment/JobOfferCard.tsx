...
import { Eye, Edit2, Tag, FileText, Calendar, Clock, DollarSign, Users, Globe, Share2, CheckCircle, ChevronRight, RotateCcw } from 'lucide-react';
...
export const JobOfferCard = ({ offer, onViewDetails, onEdit, onPublish, onClose, onReopen }: JobOfferCardProps) => {
  return (
      ...
      <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-start">
        ...
        <div className="space-y-3 lg:w-64">
          {offer.status === 'draft' ? (
            ...
            <button
              onClick={() => onReopen(offer)}
              className="flex items-center justify-center w-full px-4 py-3 space-x-2 font-medium text-white transition-all shadow-lg bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl hover:from-amber-600 hover:to-orange-600"
            >
              <RotateCcw className="w-5 h-5" />
              <span>Rouvrir l'offre</span>
            </button>
          ) : null}
