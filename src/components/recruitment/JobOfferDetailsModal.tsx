...
import { XCircle, Briefcase, FileText, Users, Calendar, Clock, DollarSign } from 'lucide-react';
...
export const JobOfferDetailsModal = ({ isOpen, onClose, offer, onEdit, onPublish, onCloseOffer }: JobOfferDetailsModalProps) => {
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
          <div className="space-y-6">
            ...
            <div className="flex justify-center pt-4 space-x-3">
              ...
              >
                {offer.status === 'draft' ? 'Publier' : 
                 offer.status === 'published' ? 'Clôturer' : 'Ré-ouvrir'}
              </button>
              <button
                onClick={onClose}
